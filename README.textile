...
By default, <code>LoanDuration</code> is considered in years but you can specify in months by adding <code>m</code> at the end.  For instance, a value 15 would be 15 years but 16m would be considered 16 months.
...
table{border:1px solid black}. | _. Parameter | _. Default Value |
| Rate | 6% |
...
All the code, documents and related content for this project is released under the GNU AFFERO GENERAL PUBLIC LICENSE.  For more information please refer to the included "LICENSE":http://github.com/rajkrish/loan-calculator/blob/master/LICENSE file.
